...
plt.plot(x, delta_cdm_1,label=r'$\delta_{CDM}$ - k=0.1[1/Mpc]')
plt.plot(x, delta_cdm_01,label=r'$\delta_{CDM}$ - k=0.01[1/Mpc]')
plt.plot(x, delta_cdm_001,label=r'$\delta_{CDM}$ - k=0.001[1/Mpc]')
plt.plot(x, np.abs(delta_b_1),'--',label=r'$\delta_b$ - k=0.1[1/Mpc]')
plt.plot(x, np.abs(delta_b_01),'--',label=r'$\delta_b$ - k=0.01[1/Mpc]')
...
plt.plot(x, v_cdm_1,label=r'$v_{CDM}$ - k=0.1[1/Mpc]')
plt.plot(x, v_cdm_01,label=r'$v_{CDM}$ - k=0.01[1/Mpc]')
plt.plot(x, v_cdm_001,label=r'$v_{CDM}$ - k=0.001[1/Mpc]')
plt.plot(x, np.abs(v_b_1),'--',label=r'$v_b$ - k=0.1[1/Mpc]')
plt.plot(x, np.abs(v_b_01),'--',label=r'$v_b$ - k=0.01[1/Mpc]')
plt.plot(x, np.abs(v_b_001),'--',label=r'$v_b$ - k=0.001[1/Mpc]')
plt.yscale('log')
plt.legend()
...
plt.plot(x, 4*theta_1,label='k=0.1[1/Mpc]')
plt.plot(x, 4*theta_01,label='k=0.01[1/Mpc]')
plt.plot(x, 4*theta_001,label='k=0.001[1/Mpc]')
plt.legend()
...
plt.plot(x, -3*theta1_1,label='k=0.1[1/Mpc]')
plt.plot(x, -3*theta1_01,label='k=0.01[1/Mpc]')
plt.plot(x, -3*theta1_001,label='k=0.001[1/Mpc]')
plt.legend()
...
plt.plot(x, phi_1,label='k=0.1[1/Mpc]')
plt.plot(x, phi_01,label='k=0.01[1/Mpc]')
plt.plot(x, phi_001,label='k=0.001[1/Mpc]')
plt.legend()
plt.title(r'$\Phi$')
plt.xlabel(r'$x$')
