...
int main(int argc, char **argv){
  ...
  double kvalue01 = 0.1 / Constants.Mpc;
  pert.output(kvalue01, "perturbations_k0.1.txt");

  double kvalue001 = 0.01 / Constants.Mpc;
  pert.output(kvalue001, "perturbations_k0.01.txt");
